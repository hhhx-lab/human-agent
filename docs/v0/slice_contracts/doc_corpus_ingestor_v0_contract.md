...
生命目标声明：本文档定义第一次生命激活 P0 的工程合同。`DocCorpusIngestor` 的使命是把 `docs/` 中 `00-258` 的理论底座和 `docs/v0/` 合同转成可运行的文档承载索引。它不是普通文档索引器，而是数字生命第一次激活前的理论摄取器、方向记忆器和断联恢复入口。
...
| `LifeStateStore` | 生命状态根 | `17-18`、`21-22`、`25-30`、`41`、`48`、`57`、`61`、`69`、`123-133`、`docs/v0/shared_contracts/life_state_store_v0_schema.md` |
| `LifeMembraneStageGate` | 生命膜、validator、quarantine | `13-16`、`33-36`、`37-48`、`49-84`、`91`、`97-100`、`102-118`、`119-122`、`docs/v0/slice_contracts/s03_direction_life_membrane_engineering_contract.md` |
| `BirthReadinessRuntime` | 出生准备度九项目标 | `143`、`146`、`149`、`152`、`171`、`174`、`docs/v0/shared_contracts/birth_readiness_v0_contract.md` |
| `RunnerCliRuntime` | 命令、report、receipt | `35`、`53`、`62`、`118`、`123`、`131`、`136`、`155`、`158-168`、`docs/v0/shared_contracts/runner_cli_report_contract.md` |
| `ActivationGrowthRuntime` | 激活、观察、巩固、成长 | `181-204`、`205-257`、`docs/v0/shared_contracts/first_activation_protocol.md` |
| `V0ContractCoverageRuntime` | v0 合同覆盖与第一次有限激活 preflight | `258`、`docs/v0/*` |
| `ComputerPeripheralRuntime` | 电脑外周与世界接触 | `12`、`15`、`20`、`24`、`28`、`32`、`89`、`docs/v0/references/current_agent_shell_reference_2026.md` |
| `WorldContactMembrane` | 外部后果进入生命膜的接触层 | `12`、`15`、`20`、`24`、`28`、`32`、`89`、`docs/v0/references/current_agent_shell_reference_2026.md` |
