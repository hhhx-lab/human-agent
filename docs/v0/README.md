...
| `code_scaffolds/` | 代码脚手柜：把蓝图、包规格与回合流继续压成真正可以直接写文件的脚手架 |
...
后续如果继续写代码，不能再把 one-shot restore、repo-local resident、安装态 resident 和命名入口都笼统叫成“digital life 壳”。
