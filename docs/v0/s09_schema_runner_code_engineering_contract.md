...
| `docs/v0/runner_cli_report_contract.md` | CLI、report、digest、stage gate、exit code |
| `docs/v0/s05_validation_membrane_observation_engineering_contract.md` | checker findings、dashboard source、quarantine refs |
