...
| 已有器官 | `candidate_arena.py`、`go_nogo.py`、`world_contact_gate.py`、`side_effect_review.py`、`responsibility_loop.py`、`action_intent_bridge.py`、`observation_truth_gate.py`、`confirmation_binding.py` |
| 下一轮目标文件 | `world_contact_summary.py` |
...
| 已有器官 | `observation_validator.py`、`boundary_audit.py`、`world_contact_validator.py`、`prediction_trace_validator.py` |
| 下一轮目标文件 | `validation_rollup.py` |
...
| 下一轮目标文件 | `run_manifest.py`、`cross_file_logic.py` |
