...
| 已有器官 | `heartbeat.py`、`continuity_writeback.py`、`turn_io.py`、`dialogue_events.py`、`response_surface.py`、`incident_recovery.py`、`relaunch_recovery.py`、`process_report.py`、`idle_strategy.py`、`resident_supervision.py`、`idle_refresh_loop.py`、`live_turn_cycle.py`、`process_session_loop.py`、`persistent_process.py`、`resident_turn_writeback.py`、`process_closeout.py` |
| 下一轮目标文件 | `idle_strategy.py`、`persistent_process.py`、`process_closeout.py`（继续补厚后台 resident governance 与高频 heartbeat 节律） |
