...
| 已有器官 | `heartbeat.py`、`continuity_writeback.py`、`turn_io.py`、`dialogue_events.py`、`response_surface.py`、`incident_recovery.py`、`relaunch_recovery.py`、`process_report.py`、`idle_strategy.py`、`idle_refresh_loop.py`、`persistent_process.py`、`resident_turn_writeback.py`、`process_closeout.py` |
| 下一轮目标文件 | `resident_supervision.py` |
...
| 下一轮目标文件 | `-（terminal_loop 首轮 waiting-state handoff 器官已落；下一前沿转向 process_supervisor/__init__.py 的 resident supervision orchestration）` |
