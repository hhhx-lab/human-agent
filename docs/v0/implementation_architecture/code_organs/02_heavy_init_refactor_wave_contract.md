...
|---|---|
| 当前行数 | 315 |
| 先切职责 | dialogue turn、conversation carryover、remaining resume orchestration |
| 已有器官 | `restore_context.py`、`context_accumulation.py`、`turn_transition.py`、`turn_packet.py` |
| 下一轮目标文件 | `dialogue_turn.py`、`conversation_carryover.py` |
