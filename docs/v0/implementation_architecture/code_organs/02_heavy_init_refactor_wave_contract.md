...
| 已有器官 | `dialogue_writeback.py`、`loop_state.py`、`resume_packet.py`、`loop_report.py` |
| 下一轮目标文件 | `conversation_carryover.py`、`persistent_wait_bridge.py` |
...
| 下一轮目标文件 | `-（terminal_turn 首轮核心器官已落；下一前沿转向 terminal_loop/persistent_wait_bridge.py）` |
