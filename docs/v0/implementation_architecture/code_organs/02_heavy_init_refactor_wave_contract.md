...
|---|---|
| 当前行数 | 447 |
| 先切职责 | dialogue turn、conversation carryover、packet/report 收束 |
| 已有器官 | `restore_context.py`、`context_accumulation.py`、`turn_transition.py` |
| 下一轮目标文件 | `dialogue_turn.py`、`conversation_carryover.py`、`turn_packet.py` |
