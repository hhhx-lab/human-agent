...
|---|---|
| 当前行数 | 236 |
| 先切职责 | dialogue turn、remaining resume orchestration |
| 已有器官 | `restore_context.py`、`context_accumulation.py`、`turn_transition.py`、`turn_packet.py`、`conversation_carryover.py` |
| 下一轮目标文件 | `dialogue_turn.py` |
