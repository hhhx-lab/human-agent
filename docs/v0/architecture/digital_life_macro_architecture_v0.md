...
| `life_v0/process_supervisor/`、`digital_life/`、`shell_command/`、`digital_entry.py`、`digital` | 出生壳、repo-local shell、最小常驻生命进程 | `LifeMembraneAndComputerPeripheralRuntime` 的外层过程 | 继续拆 `heartbeat.py`、`dialogue_event.py`、`response_surface.py`、`process_session_loop.py` |
