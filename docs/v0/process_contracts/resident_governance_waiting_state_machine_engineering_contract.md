...
- `heartbeat_cadence_presence`：承接 `heartbeat_cadence_explanation_v0`、`heartbeat_cadence_driver / reason / modulators / evidence_refs`、heartbeat interval 与下一步 idle action；它表示等待心跳为什么这样跳，而不是仅记录心跳次数。
