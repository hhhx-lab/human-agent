...
| 已落器官 | `restore_context.py`、`context_accumulation.py`、`turn_transition.py`、`turn_packet.py`、`conversation_carryover.py`、`dialogue_turn.py` |
| 下一轮器官 | `-（first terminal turn 首轮核心器官已落；下一前沿转向 terminal-loop continuity bridge）` |
