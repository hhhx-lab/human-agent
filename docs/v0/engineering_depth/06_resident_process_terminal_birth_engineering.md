...
10. `life_v0/process_supervisor/trait_convergence_signals.py` 已把后台人格慢变量 presence、convergence summary/history、trait drift monitor 与 closeout refs 合成为 `cross_wake_trait_convergence_profile_v0`，并继续进入 waiting governance、真实回合事件、写回包、恢复包和回应表达面
