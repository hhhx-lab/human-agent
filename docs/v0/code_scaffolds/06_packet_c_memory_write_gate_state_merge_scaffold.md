...
| 文件 | 本轮职责 |
|---|---|
| `life_v0/state_store/state_merge_guard.py` | 新增长期治理器官，定义 promotion / quarantine / repair / merge route |
...
| `life_v0/state_store/life_state.py` | 在 `life_state.json` 中记录 state merge records 和 memory index ref |
