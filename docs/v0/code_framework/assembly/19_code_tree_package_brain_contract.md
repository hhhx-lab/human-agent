...
| `terminal_loop/` | 等待态、回合循环、写回 bundle、持续存在桥 | `real + thicken` | `loop_state.py`、`resume_packet.py`、`dialogue_writeback.py`、`loop_report.py` | `persistent_wait_bridge.py` | `89`、`90`、`96`、`101` | `DialogueWritebackBundle`、`RelationTurnFrame`、`ExpressionPlan` | `terminal_life_loop_packet.json`、`terminal_life_loop_report.json`、`terminal_life_loop_state.json`、`dialogue_writeback_bundle.json` | `tests/bridges/test_terminal_life_loop.py`、`terminal_life_loop_gate`、`dialogue_writeback_bundle_gate` |
