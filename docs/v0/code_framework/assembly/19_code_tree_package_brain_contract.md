...
| `terminal_turn/` | 第一回合恢复、上下文接续、关系回合起点 | `real + thicken` | `restore_context.py`、`context_accumulation.py`、`turn_transition.py` | `dialogue_turn.py`、`conversation_carryover.py` | `86`、`89`、`90`、`96`、`101` | `LifeContextFrame`、`RelationTurnFrame` | `first_terminal_turn_packet.json`、`session_envelope.json`、`context_accumulation_window.json`、`turn_transition_trace.json` | `tests/bridges/test_first_terminal_turn.py`、`context_accumulation_gate`、`turn_transition_gate` |
