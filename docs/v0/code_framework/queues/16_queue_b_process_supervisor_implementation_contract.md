...
5. 后台没有外部话语时必须写出 `resident_autonomous_activity_state.json`，且 activity cycle 至少完整覆盖 `sleep / memory_recall / self_thinking / growth_rehearsal / learning_consolidation` 一轮，并分别写出五个专用状态文件
