...
| 对话/语境累积/回合过渡系统 | `86`、`89`、`90`、`96`、`101` | `life_v0/terminal_turn/` | `life_v0/language/`、`life_v0/terminal_loop/`、`life_v0/process_supervisor/` | `restore_context.py`、`dialogue_turn.py`、`context_accumulation.py`、`turn_transition.py`、`conversation_carryover.py` | `session_envelope.json`、`context_accumulation_window.json`、`turn_transition_trace.json` |
