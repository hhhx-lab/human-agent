...
| 行为层 | 候选行动、抑制、影子行动、世界接触、责任、后悔、修复 | `01r`、`06`、`20`、`75`、`80-84`、`94`、`98`、`144` | `runtime_v0_architecture.md`、`s03_direction_life_membrane_engineering_contract.md`、`s10_runtime_growth_reconsolidation_engineering_contract.md` | `life_v0/membrane/`、`life_v0/shell_command/`、`life_v0/digital_life/` | `candidate_arena.py`、`go_nogo.py`、`world_contact_gate.py`、`side_effect_review.py`、`shadow_gate.py`、`responsibility_loop.py`、`world_contact_summary.py` | `runtime/state/action/*`、`runtime/state/membrane/world_contact_summary.json`、`pain_regret_repair_report.json` | `tests/process/test_digital_life_shell_command.py`、`tests/slices/test_life_membrane.py`、`shadow_action_gate`、`responsibility_loop_gate` |
...
| 终端诞生与常驻进程层 | repo-local `./digital life` 与安装后 `digital life` 最小常驻回合、等待态 heartbeat、后台 resident lifecycle、关系投递、自主活动、异常恢复、重启恢复至少同轮可证 |
