...
6. `IdleContinuityFrame` / `DialogueWritebackBundle` / `LifeContextFrame`
7. `ReplayCueBundle` / `OfflineConsolidationFrame` / `GrowthPatchCandidateQueue`
8. `resident_supervision.py`
9. waiting heartbeat 到真实下一回合之间的显式对象回写
