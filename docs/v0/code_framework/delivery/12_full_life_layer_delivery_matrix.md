...
4. `idle_refresh_loop.py`
5. `ReplayCueBundle` / `OfflineConsolidationFrame` / `GrowthPatchCandidateQueue`
6. waiting heartbeat 到真实下一回合之间的显式对象回写
