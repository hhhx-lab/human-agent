...
| 感知、预测、世界接触 | 外界观察进入生命膜，预测误差驱动修正 | `04`、`12`、`20`、`64`、`72`、`75`、`80-84`、`01v-01ax` | `09_perception_prediction_world_contact_implementation_playbook.md`、`s03_direction_life_membrane_engineering_contract.md` | `life_v0/neural_core/__init__.py`、`belief_state.py`、`prediction_error.py`、`active_sampling.py`、`life_v0/membrane/__init__.py`、`life_v0/schema_runner/__init__.py` | `belief_state.py`、`prediction_error.py`、`active_sampling.py` 已落；下一步转向 `world_observation.py`、`periphery_normalizer.py` 与 membrane 深消费 | `runtime/state/prediction/belief_state_frame.json`、`prediction_error_field.json`、`active_sampling_plan.json`、`runtime/state/observation/*`、observation reports | `tests/slices/test_neural_life_core.py`、`tests/slices/test_schema_runner.py`、`tests/slices/test_validation_membrane.py`、`validation_membrane_gate` |
