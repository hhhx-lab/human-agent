...
7. `IdleContinuityFrame` / `DialogueWritebackBundle` / `LifeContextFrame`
8. `ReplayCueBundle` / `OfflineConsolidationFrame` / `GrowthPatchCandidateQueue`
9. `live_turn_cycle.py`
10. waiting heartbeat 到真实下一回合之间的显式对象回写
