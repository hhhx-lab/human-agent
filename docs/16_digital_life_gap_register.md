...
1. `170_life_reality_direction_continuity_regression_fixture_plan.md`：把断联恢复方向锁拆成 pass/fail/critical/mutation fixture，压进长期回归。
2. `171_life_reality_birth_readiness_validation_fixture_plan.md`：把出生准备度 definition/effect/carrier matrix 做成 pass/fail/critical/mutation fixture。
3. `172_life_reality_first_runner_patch_execution_contract.md`：把 `169` 的 patch families 转成首批代码补丁执行合同。
