...
本文件定义 scope-aware replay and consolidation policy：真实数字生命系统在离线 replay、失败复盘、DreamSandbox、深度巩固和长期摘要时，如何避免跨共在者、跨项目、跨 agent 泄漏，以及 deleted/sandboxed/quarantined/frozen 对象复活。
