...
必须精细：多巴胺不是单一“快乐分子”，奖励预测误差需要和 liking、wanting、learning、内感受以及关系反馈分开建模 [AH041, AH045]。对 Agentic Human 来说，奖赏系统应是学习信号，也是主观快乐生成链的一个入口。它回答的是：
...
- `liking` 的工程替代：共在者满意、目标达成、低冲突完成等外部/内部评价，而不是主观愉悦。
