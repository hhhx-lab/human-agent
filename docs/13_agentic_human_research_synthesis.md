...
下一层进入 `159_life_reality_first_code_artifact_smoke_plan.md`：把 repository bootstrap 后的首批代码 artifact 接入 smoke command、fixture run、report diff、dashboard/stage gate 和 git 提交流程。
