...
下一层应进入 `133_life_reality_first_json_writer_and_reporter_contract.md`：把 `132` 的写入锁转成 `json_file_writer`、`report_writer`、`gap_feedback_writer`、atomic write、canonical digest、problem detail、trace context 和 artifact record 的字段级合同。
