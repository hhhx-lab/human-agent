...
下一层进入 `153_life_reality_full_archive_cross_file_checker_rollup_plan.md`：把 language action、authority schema 和 birth readiness 三类 checker report 上卷为全库 archive cohesion、birth readiness、stage gate 和 future runner implementation queue。
