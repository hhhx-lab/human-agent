...
下一层进入 `158_life_reality_cross_file_checker_repository_bootstrap_plan.md`：把 `157` 固定的 package layout、module contracts、console script、fixtures 和 tests 推进到真实 repository bootstrap、`pyproject.toml`、`src/` package、schema roots、report roots 和 smoke command 初始文件。
