...
下一层应进入 `135_life_reality_schema_dependency_graph_and_lockfile_plan.md`：把 case files、mutation patches、expected reports、actual reports、diff reports、artifact records、ref edges、coverage matrix 和 canonical digest 写成 machine-readable dependency lockfile、graph export 和 regression baseline。
