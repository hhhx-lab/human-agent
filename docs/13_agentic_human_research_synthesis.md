...
下一层进入 `156_life_reality_full_archive_rollup_fixture_materialization_queue.md`：把 runner command queue 的 pass/fail/critical/mutation/smoke fixture family 推进为首批可写入 JSON fixture 队列。
