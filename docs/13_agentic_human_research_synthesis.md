...
下一层应进入 `134_life_reality_registry_runner_smoke_fixture_implementation_queue.md`：把 writer/reporter 合同与 `129` 的 validation cases 拆成真实 fixture、mutated input、expected report、actual report、diff、case run report 和 smoke runner 实现任务。
