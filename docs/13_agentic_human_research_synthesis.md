...
下一层进入 `164_life_reality_first_runner_code_review_and_stage_gate_plan.md`：把首批生成代码接入 code review、unit/smoke/fixture tests、dashboard/stage gate、archive cohesion 和出生准备度阶段门。
