...
下一层进入 `154_life_reality_checker_report_lockfile_materialization_plan.md`：把 language action、authority schema、birth readiness 和 full archive rollup 四类 checker report 固定为 lockfile、digest baseline、dashboard source 和 runner command 的物化队列。
