...
下一层进入 `161_life_reality_code_artifact_archive_cohesion_execution_plan.md`：把 code artifact、dashboard panel、stage gate、gap feedback、life target carrier 和 source docs 反接全库 archive cohesion、README index、cross-file checker 和出生准备度阶段门。
