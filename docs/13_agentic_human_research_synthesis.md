...
下一层进入 `149_life_reality_birth_readiness_fixture_schema_materialization_plan.md`：把 `146` 的 birth readiness fixture manifest、coverage matrix、expected report、dashboard source、stage gate review、authority schema refs 和 language action refs 推进为真实 schema 与 smoke cases。
