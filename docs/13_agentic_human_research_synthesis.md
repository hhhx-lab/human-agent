...
下一层进入 `151_life_reality_authority_schema_cross_file_checker_plan.md`：把 authority schema registry、language action closure edges、birth readiness authority refs、gap feedback、lockfile regression 和 archive cohesion graph 接入 authority schema cross-file checker。
