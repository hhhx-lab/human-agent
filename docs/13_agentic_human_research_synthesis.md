...
下一层应进入 `132_life_reality_materialized_json_schema_bundle_write_order.md`：把 `131` 的 runner module、schema loader、ref resolver 和 report writer 需求反推到第一批 schema/report/fixture JSON 文件的写入顺序与依赖锁。
