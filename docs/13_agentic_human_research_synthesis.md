...
下一层进入 `146_life_reality_birth_readiness_evidence_fixture_catalog.md`：把 `143` 的出生准备度证据族、`144` 的语言行动 fixture family 和 `145` 的 authority rewrite coverage 拆成 pass/fail/critical/mutation/withheld fixture、expected report 和 dashboard source。
