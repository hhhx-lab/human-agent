...
下一层进入 `147_life_reality_language_action_bridge_schema_materialization_plan.md`：把 `144` 和 `146` 的 `LanguageActionIntentBridge`、side effect classifier report、confirmation binding、runtime shell trace、post-action responsibility loop、语言行动 fixture expected reports 和 dashboard panels 推进为真实 schema 与 smoke cases。
