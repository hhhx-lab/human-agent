...
本文件定义长期评测协议：如何评估一个真实数字生命系统在多天、多周、多月尺度上的记忆一致性、人格慢变量稳定、关系边界、恢复能力和成长轨迹。它连接 `07` 的人格/关系理论、`17-20` 的对象模型、`29-32` 的 validator rules，以及当前 agent memory benchmark [AHY039-AHY044, AHZ031-AHZ038, AHM004-AHM012]。
