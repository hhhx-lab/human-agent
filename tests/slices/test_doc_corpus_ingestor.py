...
class DocCorpusIngestorTests(unittest.TestCase):
    ...
    def test_ingest_docs_writes_contract_outputs_and_covers_life_targets(self):
        ...
        self.assertIn("docs/v0/slice_contracts/doc_corpus_ingestor_v0_contract.md", paths)
        self.assertIn("docs/v0/entry/v0_implementation_index.md", paths)
        self.assertIn("docs/v0/slice_contracts/s00_direction_foundation_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s01_source_authority_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s05_validation_membrane_observation_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s06_life_support_development_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s07_language_relationship_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s08_life_target_runtimes_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s09_schema_runner_code_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s10_runtime_growth_reconsolidation_engineering_contract.md", paths)
        self.assertIn("docs/v0/slice_contracts/s11_v0_contract_coverage_engineering_contract.md", paths)
        self.assertIn("docs/v0/entry/v0_module_execution_catalog.md", paths)
        ...
        self.assertEqual(
            paths["docs/v0/mapping/readme_block_engineering_realization_v0.md"]["engineering_slice"],
            "S11_V0_ENGINEERING_CONTRACTS",
        )
        self.assertIn(
            "DirectionLockKernel",
            paths["docs/v0/slice_contracts/s00_direction_foundation_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "docs/构思.md",
            paths["docs/v0/slice_contracts/s00_direction_foundation_engineering_contract.md"]["dependencies"],
        )
        self.assertIn(
        ...
        self.assertIn(
            "DirectionLockKernel",
            paths["docs/v0/entry/v0_implementation_index.md"]["runtime_carriers"],
        )
        self.assertIn(
            "docs/v0/slice_contracts/s00_direction_foundation_engineering_contract.md",
            paths["docs/v0/entry/v0_implementation_index.md"]["dependencies"],
        )
        self.assertIn(
            "SourceAuthorityRegistry",
            paths["docs/v0/slice_contracts/s01_source_authority_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "docs/01_literature_matrix.md",
            paths["docs/v0/slice_contracts/s01_source_authority_engineering_contract.md"]["dependencies"],
        )
        self.assertIn(
            "LifeMembraneStageGate",
            paths["docs/v0/slice_contracts/s05_validation_membrane_observation_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "LifeSupportDefenseRuntime",
            paths["docs/v0/slice_contracts/s06_life_support_development_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "LanguageRelationshipRuntime",
            paths["docs/v0/slice_contracts/s07_language_relationship_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "BirthReadinessRuntime",
            paths["docs/v0/slice_contracts/s08_life_target_runtimes_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "RunnerRepositoryKernel",
            paths["docs/v0/slice_contracts/s09_schema_runner_code_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "ReconsolidationReplayRuntime",
            paths["docs/v0/slice_contracts/s10_runtime_growth_reconsolidation_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "V0ContractCoverageRuntime",
            paths["docs/v0/slice_contracts/s11_v0_contract_coverage_engineering_contract.md"]["runtime_carriers"],
        )
        self.assertIn(
            "V0ContractCoverageRuntime",
            paths["docs/v0/entry/v0_module_execution_catalog.md"]["runtime_carriers"],
        )
