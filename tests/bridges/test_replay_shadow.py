...
class ReplayShadowTests(unittest.TestCase):
    ...
    def test_run_replay_shadow_writes_replay_bundle(self):
        ...
        self.assertTrue(seed_bundle["repair_followup_required"])
        ...
        self.assertTrue(language_probe["responsibility_language_writeback_refs"])
        self.assertEqual(language_probe["world_contact_release_posture"], "shadow_only_guarded")
        self.assertTrue(language_probe["repair_followup_required"])
        self.assertTrue(language_probe["repair_obligation_refs"])
        ...
        self.assertEqual(dream_probe["world_contact_summary_ref"], "runtime/state/membrane/world_contact_summary.json")
        self.assertEqual(dream_probe["world_contact_release_posture"], "shadow_only_guarded")
        self.assertTrue(dream_probe["regret_pressure_refs"])
        self.assertTrue(dream_probe["repair_followup_required"])
        ...
        self.assertTrue(expression_report["responsibility_writeback_refs"])
        self.assertEqual(expression_report["world_contact_release_posture"], "shadow_only_guarded")
        self.assertTrue(expression_report["repair_followup_required"])
        self.assertTrue(expression_report["repair_obligation_refs"])
        ...
        self.assertEqual(arbitration["world_contact_release_posture"], "shadow_only_guarded")
        self.assertTrue(arbitration["repair_followup_required"])
        ...
        self.assertEqual(stage_gate["gates"]["responsibility_loop_gate"], "closed")
        self.assertEqual(stage_gate["gates"]["world_contact_summary_gate"], "closed")
        self.assertEqual(stage_gate["gates"]["pain_regret_repair_gate"], "closed")
